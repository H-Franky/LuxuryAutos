...
public class TablaVentas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Monto_Total");

        jLabel6.setText("Metodo_Pago");

        jLabel7.setText("Fecha_Venta");
    ...
    String idVenta = jTextField1.getText(); // Supongo que el campo idVenta es ingresado por el usuario
    String idCliente = jTextField5.getText();
    String idVehiculo = jTextField2.getText();
    String montoTotal = jTextField3.getText();
    String metodoPago = jTextField4.getText();
    String fechaVenta = jTextField6.getText();

    try (Connection conn = ConexionSQLServer.getConnection()) {
        String query = "INSERT INTO Ventas (IdVenta, IdCliente, IdVehiculo, MontoTotal, MetodoPago, FechaVenta) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        try (PreparedStatement pstmt = conn.prepareStatement(query)) {
            ...
            pstmt.setString(5, metodoPago);
            pstmt.setString(6, fechaVenta);
    ...
    int idVenta = Integer.parseInt(jTable1.getValueAt(selectedRow, 0).toString());
    String idCliente = jTable1.getValueAt(selectedRow, 1).toString();
    String idVehiculo = jTable1.getValueAt(selectedRow, 2).toString();
    String montoTotal = jTable1.getValueAt(selectedRow, 3).toString();
    String metodoPago = jTable1.getValueAt(selectedRow, 4).toString();
    String fechaVenta = jTable1.getValueAt(selectedRow, 5).toString();

    // Establecer los valores en los JTextField
    jTextField1.setText(String.valueOf(idVenta));
    jTextField5.setText(idCliente);
    jTextField2.setText(idVehiculo);
    jTextField3.setText(montoTotal);
    jTextField4.setText(metodoPago);
    jTextField6.setText(fechaVenta);
...
if (filaSeleccionada == -1) {
    JOptionPane.showMessageDialog(null, "Debes seleccionar una venta para eliminar", "Error", JOptionPane.ERROR_MESSAGE);
    return;
}
...
int confirmacion = JOptionPane.showConfirmDialog(null, "¿Estás seguro de que deseas eliminar esta venta?", "Confirmar eliminación", JOptionPane.YES_NO_OPTION);
if (confirmacion == JOptionPane.YES_OPTION) {
    ...
    int idVenta = Integer.parseInt(jTextField1.getText());
    String idCliente = jTextField5.getText();
    String idVehiculo = jTextField2.getText();
    String montoTotal = jTextField3.getText();
    String metodoPago = jTextField4.getText();
    ...
    try {
        Connection conn = ConexionSQLServer.getConnection();
        PreparedStatement ps = conn.prepareStatement("UPDATE Ventas SET IdCliente = ?, IdVehiculo = ?, MontoTotal = ?, MetodoPago = ?, FechaVenta = ? WHERE IdVenta = ?");
        ps.setString(1, idCliente);
        ps.setString(2, idVehiculo);
        ps.setString(3, montoTotal);
    ...
    try {
        Connection conn = ConexionSQLServer.getConnection();
        PreparedStatement ps = conn.prepareStatement("SELECT * FROM Ventas");
        ...
        while (rs.next()) {
            ...
            fila[3] = rs.getDouble("MontoTotal");
            fila[4] = rs.getString("MetodoPago");
            fila[5] = rs.getString("FechaVenta");
            modelo.addRow(fila);
        }
